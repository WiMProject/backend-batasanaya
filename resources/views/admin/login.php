                ...
                <div class="login-card">
                    ...
                    <form id="adminLoginForm">
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" id="email" value="admin@mail.com" placeholder="Enter your email" required>
                            </div>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="login-footer text-center">
                        <div class="alert alert-info mb-0">
                            ...
                            <small><strong>Default:</strong> admin@mail.com / admin123</small>
                        </div>
                    </div>
                </div>
