            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="assets">
                    <div class="admin-content p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h3 class="mb-1"><i class="fas fa-images me-2"></i>Asset Management</h3>
                                <p class="text-muted mb-0">Upload and manage game assets (images, audio, etc.)</p>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                <select class="form-select" id="assetSubcategory" disabled>
                                    <option value="">-- All Subcategories --</option>
                                </select>
                            </div>
                            <div class="col-md-3">
                                <button class="btn btn-danger w-100" id="bulkDeleteBtn" onclick="bulkDeleteAssets()" disabled>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="assetsTable">
                                <thead>
                                    <tr>
                                        <th><input type="checkbox" id="selectAllAssets" onchange="selectAllAssets()"></th>
                                        <th>Preview</th>
                                        <th>Filename</th>
                                        <th>Category</th>
                                        <th>Subcategory</th>
                                ...
                                <tbody>
                                    <tr><td colspan="10" class="text-center">Loading assets...</td></tr>
                                </tbody>
                            </table>
                        </div>
                        
                        <input type="file" id="uploadAssetFile" multiple accept=".jpg,.jpeg,.png,.mp3,.wav,.ogg,.json" style="display: none;">
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="songs">
                    <div class="admin-content p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h3 class="mb-1"><i class="fas fa-music me-2"></i>Song Management</h3>
                                <p class="text-muted mb-0">Upload and manage audio songs</p>
                            </div>
                        ...
                        <input type="file" id="uploadSongFile" accept=".mp3,.wav,.ogg" style="display: none;">
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="videos">
                    <div class="admin-content p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                <h3 class="mb-1"><i class="fas fa-video me-2"></i>Video Management</h3>
                                <p class="text-muted mb-0">Upload and manage video files</p>
                            </div>
                        ...
                        <input type="file" id="uploadVideoFile" accept=".mp4,.webm,.mov" style="display: none;">
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="backgrounds">
                    <div class="admin-content p-4">
                        ...
                        <input type="file" id="uploadBackgroundFile" accept=".jpg,.jpeg,.png" style="display: none;">
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form id="editAssetForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="editAssetFile" accept=".jpg,.jpeg,.png,.mp3,.wav,.ogg,.json">
